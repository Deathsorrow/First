...
public class FrameActivity extends FragmentActivity {
    ...
    private Fragment mFragments[];  //把三个Fragment都放到由父类实现的一个数组中
    private RadioGroup radioGroup;
    private FragmentManager fragmentManager;  //切换管理器
    private FragmentTransaction fragmentTransaction;   //事务管理器，管理什么时候开始什么时候结束
